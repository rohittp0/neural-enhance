...
add_arg('--out', default=None, type=str, help='Output file name. Defaults to input file name with _ne2x.png suffix.')
...
add_arg('--rendering-histogram', default=True, action='store_true', help='Match color histogram of output to input.')
